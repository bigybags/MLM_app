...
import { Container, Row, Col, Spinner, Form, Dropdown, Button, Card } from 'react-bootstrap';
    ...
    <Container fluid>
      {loading ? (
        ...
        <>
          ...
          {/* <Row className="bg-slate-200 rounded-full p-4 mt-4 mb-4 flex items-center justify-between">
            <Col md={6}>
              <Form.Control
                type="text"
            ...
            <Col md={6} className="flex justify-end">
              <Dropdown onSelect={(e) => setSortOrder(e)} className="mr-2">
                <Dropdown.Toggle variant="light" className="rounded-full">
          ...
          <Row className='mb-2 bg-[#F6F6F6] p-[1%]'>
            <Col className='rounded-sm'>
              <img src={banner_image1}  ></img>
            </Col>
            <Col className='rounded-sm'>
              <img src={banner_image2}></img>
            </Col>
            <Col className='rounded-sm'>
              <img src={banner_image3}></img>
            </Col>
          </Row>
                  ...
                  <div className="flex overflow-x-auto custom-scrollbar py-2">
                    ...
                    <div className="flex gap-[17%]">
                      {filteredProducts
                        ...
                        .map((product) => (
                          <div key={product.id} className="flex-shrink-0 w-[180px] h-[250px] p-2">
